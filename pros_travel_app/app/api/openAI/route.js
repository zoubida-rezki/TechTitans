...
const conversation = [{
    ...
    {
        'role': 'assistant',
        'content': 'StartingLocation : IAH, EndingLocation : CDG, DateofDeparture 02 17 2024: , DateofReturn : 02 24 2024, Baggage : 0, FlightReturn : Yes, NumberOfAdult : 1, NumberOfChilder : 0, NumberOfToddler : 0, Interval : False, Misspelled : False, NotIncluded : DateofDeparture DateofReturn Baggage NumberOfAdult NumberOfChilder NumberOfToddler.'
    },
    {
        'role': 'user',
    ...
    {
        'role': 'assistant',
        'content': 'StartingLocation : TPA, EndingLocation : DEL, DateofDeparture : 03 12 2024, DateofReturn : 03 26 2024, Baggage : 0, FlightReturn : Yes, NumberOfAdult : 1, NumberOfChilder : 0, NumberOfToddler : 0, Interval : False, MissSpelled : False, NotIncluded : NumberOfAdult NumberOfChilder NumberOfToddler.'
    },
    {
        'role': 'user',
    ...
    {
        'role': 'assistant',
        'content': 'StartingLocation : TPA, EndingLocation : HND, DateofDeparture : 02 18 2024, DateofReturn : n/a, Baggage : 0, FlightReturn : No, NumberOfAdult : 1, NumberOfChilder : 0, NumberOfToddler : 0, Interval : False, Misspelled: False, NotIncluded : DateofDeparture DateofReturn Baggage NumberOfAdult NumberOfChilder NumberOfToddler.'
    },
    {
        'role': 'user',
    ...
    {
        'role': 'assistant',
        'content': 'StartingLocation : HND, EndingLocation : ICN, DateofDeparture : 02 17 2024, DateofReturn : 02 24 2024, Baggage : 0, FlightReturn : Yes, NumberOfAdult : 1, NumberOfChilder : 0, NumberOfToddler : 1, Interval : False, Misspelled: False, NotIncluded : .'
    },
    {
        'role': 'user',
    ...
    {
        'role': 'assistant',
        'content': 'StartingLocation : ATL, EndingLocation : JFK, DateofDeparture : 02 11 2024, DateofReturn : 02 19 2024, Baggage : 0, FlightReturn : Yes, NumberOfAdult : 1, NumberOfChilder : 0, NumberOfToddler : 0, Interval : True,Misspelled: False, NotIncluded : Baggage NumberOfAdult NumberOfChilder NumberOfToddler.'
    }
];
