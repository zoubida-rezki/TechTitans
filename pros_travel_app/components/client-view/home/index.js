...
import aiImage from "../../../assets/image_croped.png";
...
export default function ClientHomeView({ data }) {
  ...
  return (
    <div className="max-w-screen-xl mt-44 mb-44 px-8 xl:px-16 mx-auto" id="home">
      <AnimationWrapper>
        <motion.div
          className={
        ...
        >
          ...
          <motion.div ref={containerRef} className="flex w-full justify-end">
            ...
            >
              <div className="w-[450px] h-[550px] top-[-50px] left-[-25px] rounded-lg border-[6px] border-[#000000] absolute"></div>
              <Image
                src={aiImage}
                alt="Profile Picture"
                layout="responsive"
