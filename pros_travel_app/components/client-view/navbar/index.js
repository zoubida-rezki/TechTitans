        ...
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          ...
          <div className="col-start-10 col-end-12 font-medium flex justify-center items-center">
            <button
              ...
              className="py-3 px-6 border-[2px] bg-[#fff] border-blue-main text-[#000] font-semibold rounded-lg text-xl tracking-widest hover:shadow-blue-md transition-all outline-none"
            >
              Contact Me
            </button>
          </div>
